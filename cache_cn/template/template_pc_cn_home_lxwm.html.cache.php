...
<body>
    ...
    <div class="gjeowueo1d4cy7y9 w85">
        ...
        <div class="pagerr2">
            <p class="fsjajggejibh3q324" style="font-size: 18px;">接收資料</p>
    ...
    <!-- 系统关键js结束 -->   
                    ...
                    <form action="" class="message"  method="post" name="myform" id="myform">
                        ...
                        <table border="0">
                            ...
                            <tr>
                                <td></td>
                                <td>*輸入資料後您將會收到來自畫廊的新聞和展訊</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input class="ntbsfe" onclick="mys_ajax_submit('<?php echo $post_url; ?>', 'myform', '2000', '<?php echo $rt_url; ?>')" type="button" value="确认"></td>
                            </tr>
                        </table>
                    </form>
                </div>
