    ...
    <div class="zl_centerr w85">
        <div class="hits" style="height: 20px;">
            <div style="float:right;">
                <a href="#ky" class="active">Antiepidemic</a>
                <a href="#tln">Her strength</a>
                <a href="#qt">Other</a>
            </div>
        </div>
        <div class="top_title"><span>Antiepidemic</span></div>
        ...
        <div class="dffegwet" style="background: none;">
            ...
            <div id="ky" class="pagesfe2">
                <div style="width: 60%;">
                    <div style="width: 80%;margin: 0 auto;">
                        ...
                        <div class="gjsogggw"  ><a href="<?php echo $t['url']; ?>">To read more</a></div>
                    </div>
                </div>
            ...
            <?php } } ?>
            <?php } } ?>
            <div class="top_title" style="margin: 55px 0 40px 0;"><span>Her strength</span></div>
            ...
            <div class="pagesfe1">
                <div style="width: 60%;">
                    <div style="width: 80%;">
                        ...
                        <div class="gjsogggw"><a href="<?php echo $t['url']; ?>">Look at all</a></div>
                    </div>
                </div>
                <div class="sgjweogw12" style="width: 40%;">
                    <a href="<?php echo $t['url']; ?>"><img src="<?php echo mys_get_file($t['thumb']); ?>" alt=""></a>
        ...
        <div class="top_title" style="margin: 40px 0;"><span>Other</span></div>
