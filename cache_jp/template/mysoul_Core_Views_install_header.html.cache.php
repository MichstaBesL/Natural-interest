...
<head>
    ...
    <link href="<?php echo THEME_PATH; ?>assets/global/css/components-rounded.min.css" rel="stylesheet" id="style_components" type="text/css" />
    ...
    <link href="<?php echo THEME_PATH; ?>assets/layouts/install/css/layout.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo THEME_PATH; ?>assets/layouts/install/css/themes/default.min.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo THEME_PATH; ?>assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
...
<body scroll="no" style="overflow: hidden;" class="page-container-bg-solid login">

<div class="logo" style="margin: 20px auto 0px;">
    <a href="javascript:;"><img src="/static/assets/logo.png"> </a>
</div>
